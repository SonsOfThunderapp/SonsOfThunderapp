...
(function () {
  try {
    if (!document.querySelector('link[href*="chief1-ghost.css"]')) {
      ...
      l.rel = 'stylesheet';
      l.href = 'css/chief1-ghost.css?v=20260822-memclean2';
    ...
    if (!document.querySelector('link[href*="memories-page.css"]')) {
      ...
      p.rel = 'stylesheet';
      p.href = 'css/memories-page.css?v=20260822-memclean2';
  ...
  try {
    ...
    seeds.forEach(function (src) {
      ...
      sc.src = src + '?v=20260822-memclean2';
      sc.defer = true;
  ...
  try {
    ...
    if (!document.querySelector('script[src*="leader-door.js"]')) {
      ...
      ld.src = 'js/leader-door.js?v=20260822-memclean2';
      ld.defer = true;
    ...
    if (!document.querySelector('script[src*="tour-first.js"]')) {
      ...
      tf.src = 'js/tour-first.js?v=20260822-memclean2';
      tf.defer = true;
    ...
    if (!document.querySelector('script[src*="more-legal.js"]')) {
      ...
      ml.src = 'js/more-legal.js?v=20260822-memclean2';
      ml.defer = true;
