window.TB_CONFIG = {
  ...
  APP_BUILD: '20260823-header-app1',
...
(function () {
  try {
    ...
    if (!document.querySelector('link[href*="website-wide.css"]')) {
      ...
      ww.rel = 'stylesheet';
      ww.href = 'css/website-wide.css?v=20260823-header-app1';
  ...
  try {
    ...
    if (!document.querySelector('script[src*="leader-door.js"]')) {
      ...
      ld.src = 'js/leader-door.js?v=20260822-chrome6';
      ld.defer = true;
    ...
    if (!document.querySelector('script[src*="thunder-ask.js"]')) {
      ...
      ta.src = 'js/thunder-ask.js?v=20260822-chrome6';
      ta.defer = true;
