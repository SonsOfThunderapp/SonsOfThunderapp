...
(function () {
  ...
  // Cash App–style QR: client-side (qrcode.min.js) + small official bolt center
  // ECC H (~30% recovery). Center logo kept under ~20% of QR width so the
  // fingerprint modules stay dense and Camera apps still scan.
