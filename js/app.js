...
$('#thunder-input').addEventListener('keydown', (e) => {
  ...
  const TB_TOUR_VERSION = 3; /* Hero AHA: real Thunder demo via sample chip */
  ...
  const TB_TOUR_STEPS = [
    {
      id: 'welcome',
      view: 'home',
      target: '#view-home .logo-wrap, #view-home .header-logo, .home-header',
      headline: 'WELCOME TO THUNDER BOARD',
      body: 'The brotherhood between gatherings. Follow the bolt.',
      nextLabel: 'NEXT'
    },
    {
      id: 'gathering',
      view: 'home',
      target: '#view-home .next-meeting, #meeting-date',
      headline: 'DON’T MISS THE GATHERING',
      body: 'Date, time, place — always current. Add it to your calendar when you’re ready.',
      nextLabel: 'NEXT'
    },
    {
      id: 'imin',
      ...
      headline: 'SHOW UP',
      body: 'I’M IN locks your seat on this phone. Presence is the point.',
      nextLabel: 'NEXT',
      allowTargetTap: true
    },
    {
    ...
    },
    {
      ...
      headline: 'REMEMBER THE NIGHT',
      body: 'Missions, range, lake, Word, gym — and the photos that prove you showed up.',
      nextLabel: 'NEXT'
    },
    {
      id: 'code',
      view: 'about',
      target: '.code-title, #the-code',
      headline: 'REMEMBER WHY WE’RE HERE',
      body: 'The Code keeps hotheads aimed at gentlemen. Read it. Carry it.',
      nextLabel: 'NEXT'
    },
    {
      id: 'thunder',
      view: 'home',
      target: '#thunder-fab',
      headline: 'OR JUST ASK THUNDER',
      body: "You don't have to remember where everything lives. Ask Thunder what you need.",
      nextLabel: 'SKIP DEMO',
    ...
    },
    {
      ...
      body: "And if you don’t — ask Thunder. Show up. Thunder doesn’t dull.",
      nextLabel: 'FINISH'
    }
  ];
  ...
  function runThunderConciergeDemo(promptText) {
    ...
    // Surrender Concierge → real product
    try {
      __tourActive = false;
      setTourState({ step: 'thunder-demo', demoStarted: true });
      closeTourUI();
    } catch (e) {}
    ...
    setTimeout(function () {
      ...
      // After answer has time to land — aha + complete (user free to keep chatting)
      setTimeout(function () {
        try {
  ...
  function tourNext() {
    if (!__tourActive) return;
    const step = TB_TOUR_STEPS[__tourIdx];
    // On Thunder step, NEXT/SKIP DEMO skips the interactive demo without trapping
  ...
  function maybeStartProductTour() {
    /* MASTERPIECE: Thunder Concierge is the first-run authority (Follow the Bolt).
       Versioned, skippable, replayable. Install overlays still win the moment. */
    try {
