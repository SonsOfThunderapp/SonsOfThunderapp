...
(function () {
  ...
  async function upsert(patch) {
    ...
    inflight[key] = (async function () {
      ...
      try {
        ...
        setTimeout(function () { delete inflight[key]; }, 1500);
      }
    })();
    return inflight[key];
  }
  ...
  if (!document.querySelector('script[src*="founder-ping.js"]')) {
    var f = document.createElement('script');
    f.src = 'js/founder-ping.js';
    f.defer = true;
    (document.body || document.documentElement).appendChild(f);
  }
  if (!document.querySelector('script[src*="dock-quiet.js"]')) {
    var q = document.createElement('script');
    q.src = 'js/dock-quiet.js';
    q.defer = true;
