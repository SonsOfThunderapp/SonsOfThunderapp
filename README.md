...
| `VAPID_PRIVATE_KEY` | `TC2DQ3pGyaOVryK7YscEkKzvB5dec_LqfHhxToqI-w4` |
| `LEADER_PIN` | `thunder` |
...
- **No root `package.json`** — avoids accidental `npm run build` failures.
- **Functions only depend on `web-push`** — listed in `netlify/functions/package.json`.
